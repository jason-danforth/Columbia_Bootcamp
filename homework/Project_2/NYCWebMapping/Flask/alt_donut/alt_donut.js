//https://bl.ocks.org/SpaceActuary/97d70de639c9c1724f434a9c64cc1a68
...
function transition(from, to) {
  ...
  // "dir" is direction, +1 or -1 to define transition from data0 > data1 > data2 vs. data2 > data1 > data0
  // all the from/to stuff is just to set indices for data[x]
