...
console.log(`Han's x-coordinate: ${xScale(testScores[0])}`);
console.log(`Sarah's x-coordinate: ${xScale(testScores[1])}`);
console.log(`Matt's x-coordinate: ${xScale(testScores[2])}`);
console.log(`Ruchi's x-coordinate: ${xScale(testScores[3])}`);
