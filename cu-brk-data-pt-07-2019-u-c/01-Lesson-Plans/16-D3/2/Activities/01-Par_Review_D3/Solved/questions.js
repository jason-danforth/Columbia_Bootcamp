...
// YOUR CODE HERE//
var selection = ul.selectAll("li") // creates virtual selection (this defines what the items in the array will be BOUND to)
  .data(arr) // binds data
  .enter() // carries the remaining items in the array (all of them in this case)
...
selection.enter()
  .append("li")
  .merge(selection) // This needs to be used if some of the "li" already exist
  .text(function(d) {
    return d;
  });
