...
function buildPlot(stock) {
  ...
  d3.json(url).then(function(data) {
    ...
    var openPrice = unpack(data.dataset.data, 1);
    var highPrice = unpack(data.dataset.data, 2);
    var lowPrice = unpack(data.dataset.data, 3);
    var closePrice = unpack(data.dataset.data, 4);
