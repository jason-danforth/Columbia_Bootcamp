...
function handleSubmit() {
  ...
  var stock = d3.select("#stockInput").node().value; //This gets the value, which is a little surprising, since there's no "value" attribute
  console.log(stock);
...
// This handles the button click and calls the function