...
# The database URI
# If emoji.sqlite doesn't already exist, this line will create it
...
# This is a fairly bespoke way of creating tables
# There's nothing wrong with creating it with basic SQL syntax as an alternative
# Just set up queries as strings to the connection
